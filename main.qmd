...
1) Can the results of @casillas2023using be replicated in a slightly different experimental design? That is, are low proficiency late bilinguals who have higher empathy more sensitive to intonation to distinguish sentence modality?

2) @casillas2023using found that high empathy individuals at all proficiencies had slower reaction times. What ERP components, if any, are associated with high empathy individuals that could elicit slower reaction times?
