...
1) Is reaction time to identifying sentence modality in Spanish by L1 English L2 Spanish late bilinguals modulated by empathy [@casillas2023using]?

2) Are high empathy bilinguals more sensitive to intonation when identifying sentence modality [@brandl2020development; @casillas2023using]?

3) In mismatch conditions, are greater N400 and P600 components associated with high empathy individuals?

4) In match conditions, do high empathy individuals exhibit more broadly distributed late positivity components than their low individual counterparts?

# Hypotheses

I expect slower reaction times to correspond to later ERP components. @esteve2020empathy proposed that high empathy individuals invoked higher level processing to consider all possible interpretations of the stimulus. This processing would be relevant to N400 and P600 components. The N400 component, known to be modulated by expectations, would evoke a greater response in mismatch conditions for high empathy individuals, indicating a greater sensitivity to intonation. The P600, typically associated with syntactic reanalysis, would also be greater for high empathy individuals. A higher P600 could be associated with what @esteve2020empathy proposed: that high empathy individuals consider all possible meanings and their proportional likelihoods. Furthermore, @aziz2010common proposed that high empathy individuals consider how they themselves would produce a given utterance when perceiving speech. In this case, this could be reflected in later components, as well.
...
Areas of interest: syllable directly to the left of the nuclear pitch accent; nuclear pitch accented syllable; syllable directly to the right of the nuclear pitch accent.
