...
Empathy has remained largely uninvestigated using neurolinguistic methodologies, such as electroencephalogram (EEG) or fMRI, despite the growing evidence that it impacts both monolingual and bilingual language processing. [@aziz2010common].

## N400, P600, and LPC

## Empathy and Language Processing
...
Empathy is responsible for allowing individuals to infer another's mental state, which is critical for establishing and updating common ground [@stalnaker2002common]. Furthermore, empathy is critical in understanding an interlocuter's sarcasm or insincere utterance [@filik2019difference]. 
